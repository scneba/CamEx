...
public class TraditionalTab extends Fragment implements LoaderManager.LoaderCallbacks<String>, MusicAdapter.CustomRecyclerOnClick {
    //loader id
    private final int MY_LOADER_ID = 103;
    ...
    private String url;
    private String genre = "traditional";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.traditional_tab, container, false);
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(MUSIC_LIST)) {
            ...
            musicAdapter = new MusicAdapter(getActivity(), musicList, MusicAdapter.Genre.GOSPEL, TraditionalTab.this);
            ...
            musicAdapter = musicAdapter = new MusicAdapter(getActivity(), musicList, MusicAdapter.Genre.GOSPEL, TraditionalTab.this);
            recyclerView.setAdapter(musicAdapter);
    ...
    private void startLoader() {
        if (CheckInternetConnection.isNetworkAvailable(getContext())) {
            ...
            if (getActivity().getSupportLoaderManager().getLoader(MY_LOADER_ID) == null) {
                getActivity().getSupportLoaderManager().initLoader(MY_LOADER_ID, null, TraditionalTab.this).forceLoad();
            } else {
                getActivity().getSupportLoaderManager().restartLoader(MY_LOADER_ID, null, TraditionalTab.this).forceLoad();
            }
        } else {
