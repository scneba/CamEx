...
public class MovieDetailsActivity extends YouTubeBaseActivity {
    ...
    private static final int ASYNC_LOADER_ID = 21;
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                if (userSharedPreference.isLoggedIn()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        Bundle explodeBundle = ActivityOptions.makeSceneTransitionAnimation(MovieDetailsActivity.this).toBundle();
    ...
    void play_nex_vid() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Bundle explodeBundle = ActivityOptions.makeSceneTransitionAnimation(MovieDetailsActivity.this, next_pic_imv, next_pic_imv.getTransitionName()).toBundle();
            Bundle bundle = new Bundle();
    ...
    void play_previous_vid() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Bundle explodeBundle = ActivityOptions.makeSceneTransitionAnimation(MovieDetailsActivity.this, previous_pic_imv, previous_pic_imv.getTransitionName()).toBundle();
            Bundle bundle = new Bundle();
            bundle.putParcelableArrayList(MUSIC_LIST, musicList);
    ...
    private void insertMusic(DataModel dataModel) {
        ...
        try {
            ...
            if (movieUri != null) {
                Toast.makeText(MovieDetailsActivity.this, getString(R.string.success_add_fav), Toast.LENGTH_SHORT).show();
                isInFav = true;
                favStar.setImageResource(android.R.drawable.star_big_on);
            ...
            Toast.makeText(MovieDetailsActivity.this, getString(R.string.unable_insert), Toast.LENGTH_SHORT);
        }
    ...
    private void showMessageDialog(final String title, String body, final int type) {
        ...
        final NiftyDialogBuilder dialogBuilder = NiftyDialogBuilder.getInstance(MovieDetailsActivity.this);
    ...
    private class UpdateDataInfo implements LoaderManager.LoaderCallbacks<String> {
        ...
        public Loader<String> onCreateLoader(int id, Bundle args) {
            return new AsyncTaskLoader<String>(MovieDetailsActivity.this) {
