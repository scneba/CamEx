...
public class GospelTab extends Fragment implements LoaderManager.LoaderCallbacks<String>, MusicAdapter.CustomRecyclerOnClick {
    //loader id
    private final int MY_LOADER_ID = 100;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.gospel_tab, container, false);
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(MUSIC_LIST)) {
            ...
            musicList1 = savedInstanceState.getParcelableArrayList(MUSIC_LIST);
            musicAdapter1 = new MusicAdapter(getActivity(), musicList1, MusicAdapter.Genre.GOSPEL, GospelTab.this);
            ...
            musicAdapter1 = musicAdapter1 = new MusicAdapter(getActivity(), musicList1, MusicAdapter.Genre.GOSPEL, GospelTab.this);
            recyclerView.setAdapter(musicAdapter1);
    ...
    public void onResume() {
        super.onResume();
        musicAdapter1.notifyItemRangeChanged(0, musicAdapter1.getItemCount());
    ...
    private void startLoader() {
        if (CheckInternetConnection.isNetworkAvailable(getContext())) {
            ...
            if (getActivity().getSupportLoaderManager().getLoader(MY_LOADER_ID) == null) {
                getActivity().getSupportLoaderManager().initLoader(MY_LOADER_ID, null, GospelTab.this);
            } else {
                getActivity().getSupportLoaderManager().restartLoader(MY_LOADER_ID, null, GospelTab.this);
            }
        } else {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if (musicList1.size() > 0) {
            outState.putParcelableArrayList(MUSIC_LIST, musicList1);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.top_rated: {
                subcat = "ratings";
                getActivity().getSupportLoaderManager().initLoader(MY_LOADER_ID, null, GospelTab.this).forceLoad();
                return true;
            }
            case R.id.top_liked: {
                subcat = "likes";
    ...
    public void onCustomClick(int position, ImageView imageView) {
        ...
        bundle.putParcelableArrayList(MUSIC_LIST, musicList1);
